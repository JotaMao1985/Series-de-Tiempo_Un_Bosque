    ...
    //
    // Punto decimal, como la prosa. Los miles se agrupan con un espacio fino
    // solo desde cinco cifras enteras (80 055.01); con cuatro van juntos
    // (1267.51), como los escribe el texto.
    function fmt(x, d = 2) {
    ...
    AUTOEVALUACIONES['cap6'] = [
      {
        ...
        opciones: [
          ...
          },
          {
            ...
            correcta: true,
            retro: '<code>accuracy()</code> con un solo argumento devuelve la fila <code>Training set</code>, calculada sobre datos que el modelo usó para estimarse. La razón entre los dos números es $1.86$ en este caso, y depende del tramo: en los once cortes medidos va de $0.85$ a $4.07$.'
          },
          {
      ...
      },
      {
        ...
        respuesta: 0.8,
        tolerancia: 0.01,
        retroAcierto: '$20/25 = 0.8$. Al ser menor que $1$, el modelo comete menos error pronosticando que el naïve estacional prediciendo un paso dentro del entrenamiento. Es la única de las métricas del capítulo cuyo valor se puede leer sin saber nada de las unidades de la serie.',
      ...
      },
      {
        ...
        opciones: [
          ...
          },
          {
            ...
            correcta: true,
            retro: 'Es la conclusión útil: la misma predicción que el MAPE declara catastrófica es mejor que la referencia.'
          }
        ]
      },
      {
      ...
      },
      {
        ...
        respuesta: 61,
        tolerancia: 0.5,
        retroAcierto: 'Los orígenes van de $T_0 = 72$ a $n - h = 132$, es decir $132 - 72 + 1 = 61$, y producen $61 \\times 12 = 732$ errores de pronóstico frente a los $24$ de una partición única.',
      ...
      },
      {
        ...
        opciones: [
          ...
          },
          {
            ...
            correcta: true,
            retro: 'El sesgo medio del naïve estacional en estos orígenes es $+38.68$ frente a un RMSE de $42.55$: una razón de $0.909$. La banda de $\\pm 1.28\\sigma$ no llega y la de $\\pm 1.96\\sigma$ sí. Comprobar solo el $95\\,\\%$ habría dado el intervalo por bueno.'
          },
          {
        ...
        opciones: [
          {
            ...
            correcta: true,
            retro: 'La diferencia de $1.71$ en el RMSE agregado cabe dentro del ruido, y de hecho <code>auto.arima</code> gana en más orígenes de los que pierde. Cuando dos métodos empatan estadísticamente, deciden el costo, la simplicidad y la interpretabilidad.'
          },
          {
      ...
      },
      {
        ...
        opciones: [
          ...
          },
          {
            ...
            correcta: true,
            retro: 'Con $20$ observaciones de un solo tramo, qué tramo toque pesa más que la diferencia entre métodos. Promediando sobre $36$ orígenes el efecto se diluye y aparece lo que el Capítulo 4 ya había concluido por otras vías: la caída del caudal fue un cambio de nivel, no una pendiente.'
          },
          {
